...
const CategoryButton = ({ categoryTrees }) => {
    ...
    return (
        <div className='container mx-auto'>
            ...
            <div className='hidden md:flex items-center justify-center gap-5 md:gap-6 bg-yellow-300 py-3 px-6'>
                <button  onClick={() => setSelectBtn(null)}
                    className={` ${selectBtn === null ? "text-red-700" : "text-green-700"}  flex items-center font-bold text-md  `}>All Trees <CgPlayButton/> </button>
                {
